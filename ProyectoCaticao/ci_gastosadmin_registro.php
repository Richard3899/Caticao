            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <h1 class="h3 mb-4 text-gray-800 text-center">Registrar Gastos Administrativos y Otros</h1>
                        ...
                        <form  method="POST" action="ci_gastosadmin_save.php" enctype="multipart/form-data" id="id_form">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Tabla de Gastos Administrativos y Otros
                            </div>
                            <div class="card-body">
                                        ...
                                        while($row = mysqli_fetch_array($result)){ ?>
                                         ...
                                         <tr>
                                            ...
                                            <?php echo $row[4] ?>
                                             ...
                                             <a class="btn btn-warning" href="ci_gastosadmin_edit.php?idGastosAdmin=<?php echo $row[0] ?>" >
                                             ...
                                             <td>
                                             <a class="btn btn-danger" href="ci_gastosadmin_delete.php?idGastosAdmin=<?php echo $row[0]?>" >
